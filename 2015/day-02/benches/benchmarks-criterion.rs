...
fn criterion_benchmark_part1(c: &mut Criterion) {
    ...
    group.bench_with_input("part1_rusty", &input, |b, input| {
        b.iter(|| part1::solve_puzzle_rusty(input))
    });
    group.bench_with_input("part1_rusty_atoi", &input, |b, input| {
        b.iter(|| part1::solve_puzzle_rusty_atoi(input))
    });
    group.bench_with_input("part1_fast", &input, |b, input| {
        b.iter(|| part1::solve_puzzle_fast(input))
    });
