...
fn criterion_benchmark_part1(c: &mut Criterion) {
    ...
    group.bench_with_input("part1_v1", &input, |b, input| {
        b.iter(|| part1_v1::solve_puzzle(input))
    });
    group.bench_with_input("part1_v2", &input, |b, input| {
        b.iter(|| part1_v2::solve_puzzle(input))
    });
    group.bench_with_input("part1_timvisee", &input, |b, input| {
        b.iter(|| part1_timvisee::solve_puzzle(input))
    });
...
fn criterion_benchmark_part2(c: &mut Criterion) {
    ...
    group.bench_with_input("part2_v1", &input, |b, input| {
        b.iter(|| part2_v1::solve_puzzle(input))
    });
    group.bench_with_input("part2_v2", &input, |b, input| {
        b.iter(|| part2_v2::solve_puzzle(input))
    });
    group.finish();
}
