...
fn criterion_benchmark_part1(c: &mut Criterion) {
    ...
    group.bench_with_input("part1_str", &input, |b, input| {
        b.iter(|| part1_str::solve_puzzle(input))
    });

    group.bench_with_input("part1_vec", &input, |b, input| {
        b.iter(|| part1_vec::solve_puzzle(input))
    });

    group.bench_with_input("part1_array", &input, |b, input| {
        b.iter(|| part1_array::solve_puzzle(input))
    });
...
fn criterion_benchmark_part2(c: &mut Criterion) {
    ...
    group.bench_with_input("part2_vec", &input, |b, input| {
        b.iter(|| part2_vec::solve_puzzle(input))
    });
    group.finish();
}
